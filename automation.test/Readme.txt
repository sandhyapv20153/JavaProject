...
a.	Functional – CreateAndValidateOfferTests – This one creates the account and validates the offer values. This first test in this creates the account and stores the user account values and offer values in json. The second test reads the values in the json, sign in to the site and validates the offer values.
b.	Functional – APITests – This one runs the 3 API tests.
